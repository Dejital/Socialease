...
namespace Socialease.Migrations
{
    public partial class IdentityProperties : Migration
    {
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropForeignKey(name: "FK_IdentityUserRole<string>_IdentityRole_RoleId", table: "AspNetUserRoles");
            migrationBuilder.DropForeignKey(name: "FK_IdentityUserRole<string>_SocialUser_UserId", table: "AspNetUserRoles");
            migrationBuilder.DropColumn(name: "UserName", table: "Ping");
            migrationBuilder.DropColumn(name: "UserName", table: "Person");
            migrationBuilder.DropColumn(name: "UserName", table: "Note");
            migrationBuilder.DropColumn(name: "UserName", table: "Group");
            migrationBuilder.AlterColumn<string>(
                name: "Name",
                table: "Person",
                nullable: false);
